...
My research focuses on **political communication** and **computational journalism** in authoritarian and democratic contexts. I use social science and computational methods (i.e. BERT-based sentiment analysis, topic modeling, and text classification) to study journalism practices (i.e. institutional roles, AI/VR in newsrooms) and their effects on policymaking and public decision-making (i.e. moral passivity and slacktivism) in global humanitarian crises, including those driven by climate change and geopolitical conflicts. All of my work seeks to explore the **(de)politicization, platformization, and algorithmization of communicating human vulnerability**. Please feel free to check the full list of my publications on my [Google Scholar](https://scholar.google.de/citations?user=lxUyedYAAAAJ&hl=en&oi=sra).
